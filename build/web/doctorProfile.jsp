<%-- 
    ...
    Created on : Aug 11, 2024, 9:46:15 AM
    Author     : dilek
--%>
...
<body>
    <div class="profile-container">
        ...
        <a href="manageScheduleServlet" class="update-link">Manage Your Schedules</a>

        <!-- Link to updateDoctor.jsp -->
        <a href="updateDoctor.jsp" class="update-link">Update Your Information</a>
